      ...
      <div className="bg-white rounded-lg px-8 py-8 drop-shadow-sm">
        ...
        {/* Buttons */}
          <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
            ...
            <a href="" className="px-8 py-2.5 text-white text-sm rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-500 hover:scale-105 transition-all duration-700 cursor-pointer">Download image </a>
          </div>
      </div>
